import { n as toIndexedObject, E as objectGetOwnPropertyNames, w as wellKnownSymbol, H as path, h as has, m as objectDefineProperty, u as sharedKey, i as internalState, q as global_1, g as getBuiltIn, I as shared, j as descriptors, f as fails, J as nativeSymbol, C as uid, r as redefine, _ as _export, c as createNonEnumerableProperty, G as objectGetOwnPropertyDescriptor, a as anObject, l as toPrimitive, b as createPropertyDescriptor, y as hiddenKeys, k as objectPropertyIsEnumerable, o as objectGetOwnPropertySymbols, d as toObject, p as isObject, K as useSymbolAsUid, L as copyConstructorProperties, M as engineV8Version, t as toLength, D as toAbsoluteIndex, B as toInteger, N as arrayIncludes, e as indexedObject, O as engineIsNode, F as createCommonjsModule, P as ownKeys, s as classofRaw, A as requireObjectCoercible, Q as engineUserAgent, R as isForced_1, z as documentCreateElement, S as inspectSource, T as nativeWeakMap, U as sharedStore } from './common/to-object-b1d92deb.js';
import { a as arrayIteration, i as isArray, c as checkCorrectnessOfIteration, b as arraySpeciesCreate, d as arrayFill, s as setSpecies, e as inheritIfRequired, f as arrayBuffer, g as arrayBufferViewCore, h as arrayBufferNative, t as typedArrayFrom, j as typedArrayConstructorsRequireWrappers, k as toOffset, l as toPositiveInteger } from './common/es.typed-array.float32-array-63f1a6c1.js';
import { e as objectKeys, s as setToStringTag, b as objectCreate, d as objectSetPrototypeOf, o as objectGetPrototypeOf, f as functionBindContext, a as aFunction, k as objectDefineProperties, l as correctPrototypeGetter, t as toStringTagSupport, h as classof, m as html, j as anInstance, r as redefineAll, n as aPossiblePrototype, g as getIteratorMethod } from './common/redefine-all-3eefef53.js';
import { i as iterate, a as arrayFrom, c as createProperty, b as addToUnscopables, o as objectAssign, d as createIteratorConstructor, e as isPure, s as speciesConstructor, f as defineIterator, g as es_array_iterator, h as collectionDeleteAll, j as getIterator, k as iteratorsCore, l as callWithSafeIterationClosing, m as iteratorClose } from './common/web.url-b06561b7.js';
import { a as arrayMethodIsStrict, b as arrayReduce } from './common/es.typed-array.float64-array-7d2a5b57.js';
import { s as stringMultibyte } from './common/string-multibyte-19f91a38.js';
import { f as fixRegexpWellKnownSymbolLogic, r as regexpExecAbstract, a as advanceStringIndex, b as regexpFlags, c as regexpExec, g as getSubstitution, d as regexpStickyHelpers } from './common/es.string.replace-f180a0a7.js';
import './common/es.typed-array.uint8-array-560926a5.js';
...
if (descriptors) {
  _export({ target: 'Object', proto: true, forced: objectPrototypeAccessorsForced }, {
    __lookupSetter__: function __lookupSetter__(P) {
      ...
      var desc;
      do {
        if (desc = getOwnPropertyDescriptor$1(O, key)) return desc.set;
      } while (O = objectGetPrototypeOf(O));
    }
  });
}
...
// https://github.com/tc39/proposal-array-filtering
exportTypedArrayMethod$n('filterOut', function filterOut(callbackfn /* , thisArg */) {
  var list = $filterOut$1(aTypedArray$m(this), callbackfn, arguments.length > 1 ? arguments[1] : undefined);
  return typedArrayFromSpeciesAndList(this, list);
});
...
// https://github.com/tc39/proposal-array-find-from-last
exportTypedArrayMethod$o('findLast', function findLast(predicate /* , thisArg */) {
  return $findLast$1(aTypedArray$n(this), predicate, arguments.length > 1 ? arguments[1] : undefined);
});
...
exportTypedArrayMethod$p('findLastIndex', function findLastIndex(predicate /* , thisArg */) {
  return $findLastIndex$1(aTypedArray$o(this), predicate, arguments.length > 1 ? arguments[1] : undefined);
});
...
// https://github.com/tc39/proposal-array-unique
exportTypedArrayMethod$q('uniqueBy', function uniqueBy(resolver) {
  return typedArrayFromSpeciesAndList(this, arrayUniqueBy.call(aTypedArray$p(this), resolver));
});
...
var getInternalState$5 = internalState.getterFor(OBJECT_ITERATOR);
...
var getInternalState$8 = internalState.getterFor(STRING_ITERATOR);
...
if (FORCED$m || !has(IteratorPrototype, 'constructor') || IteratorPrototype.constructor === Object) {
