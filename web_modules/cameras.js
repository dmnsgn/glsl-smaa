import { f as fromValues, c as create, a as create$1, l as lookAt, b as copy, i as invert, d as frustum, p as perspective, o as ortho, e as create$2, z as zero, s as subtract, g as distance, h as set, j as copy$1, k as glMatrix, m as create$3, n as copy$2, q as subtract$1, r as length, t as sub, u as add, v as scale, w as transformQuat, x as rotationTo, y as invert$1 } from './_chunks/vec2-DAg_xd7W.js';
import { g as getDefaultExportFromCjs } from './_chunks/polyfills-Ca5RnHyL.js';
...
var clamp$1 = /*@__PURE__*/ getDefaultExportFromCjs(clamp_1);
...
class PointerManager {
    ...
    handleDragging(event) {
        ...
        let dy = 0;
        if (PointerManager.isTouchEvent(event) && event.touches.length >= 2) {
            dy = this.initialTouchDistance - distance([
...
class Controls {
    ...
    handleDolly(event) {
        ...
        this.sphericalTarget[2] += clamp$1(delta * this.dollySpeed, -this.dollyMaxDelta, this.dollyMaxDelta);
    }
    handleRotateAzimuth(event) {
        this.sphericalTarget[0] -= clamp$1(PI2 * event.dx * this.rotateSpeed, -this.rotateMaxThetaDelta, this.rotateMaxThetaDelta);
    }
    handleRotatePolar(event) {
        this.sphericalTarget[1] -= clamp$1(PI2 * event.dy * this.rotateSpeed, -this.rotateMaxPhiDelta, this.rotateMaxPhiDelta);
    }
    handleRotate(event) {
    ...
    update() {
        ...
        this.phi = clamp$1(this.phi, EPSILON, Math.PI - EPSILON);
        this.distance = clamp$1(this.distance, this.distanceBounds[0], this.distanceBounds[1]);
